      ...
      <div className="h-screen m-30 md:h-screen relative flex flex-col justify-center items-center ">
        <div className="bg-dark-2 shadow-none p-10 pb-0 rounded-xl">
          <div className="flex flex-col items-center space-y-3">
            <span className="text-xl md:text-2xl font-semi-bold leading-normal text-white">Nhập biệt danh của bạn!</span>
          </div>
          ...
          <form onSubmit={Login} className="my-8 w-30 md:w-96 h-32">
            <div className="relative mb-2">
              ...
              <input id="username" autoComplete='off' placeholder='biệt danh của bạn...' className="text-white bg-dark-3 transition-all duration-200 w-full rounded-lg p-3 border border-gray-300/10 focus:border-gray-700 outline-none ring-none" type="text" />
            </div>
            <div className="space-y-9">
              <div className="text-sm flex justify-end items-center h-full mt-8">
                <button className="py-2.5 px-8 rounded text-white btn bg-gradient-to-r from-gray-600 to-gray-800 hover:opacity-80 transition-all duration-200">Tiếp tục</button>
              </div>
            </div>
          </form>
        </div>
